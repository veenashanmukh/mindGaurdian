...
import PMRGame from "../components/games/PMRGame";
  ...
  return (
    <div style={{ padding: "2rem", maxWidth: 720, margin: "0 auto" }}>
      ...
      <Card style={{ marginTop: 12 }}>
        ...
        <p style={{ color: "#6b7280", fontSize: 13, marginBottom: "1rem" }}>Choose a game to practice mental wellness techniques.</p>
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
          <button onClick={() => setActiveGame("breathing")}>🫁 Breathing</button>
          <button onClick={() => setActiveGame("calm")}>🧘 Calm</button>
          <button onClick={() => setActiveGame("grounding")}>🌍 Grounding</button>
          <button onClick={() => setActiveGame("pmr")}>💪 PMR</button>
          <button onClick={() => setActiveGame("coloring")}>🎨 Coloring</button>
          <button onClick={() => setActiveGame("meditation")}>🧘‍♀️ Meditation</button>
        </div>
      </Card>
